...
class TabletSite extends StatefulWidget {
  const TabletSite({Key? key}) : super(key: key);

  @override
  State<TabletSite> createState() => _TabletSiteState();
}

class _TabletSiteState extends State<TabletSite> {
            ...
            itemIndex(
              Stack(
                ...
                children: [
                  ...
                  Padding(
                    padding: const EdgeInsets.only(left: 200, bottom: 110),
                    child: AnimatedTextKit(
                      animatedTexts: [
                        TypewriterAnimatedText(
